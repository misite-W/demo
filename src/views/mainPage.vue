<template>
    <div style="height: 100%">
            ...
            <header data-v-ad5d153c="" class="header">
                <div data-v-ad5d153c="" class="container">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item" @click="navClick(1)"><a :class="{active: activeIndex==1}">指南</a></li>
                        <li class="nav-item" @click="navClick(2)"><a :class="{active: activeIndex==2}">组件</a></li>
                        <li class="nav-item" @click="navClick(3)"><a :class="{active: activeIndex==3}">主题</a></li>
                        <li class="nav-item" @click="navClick(4)"><a :class="{active: activeIndex==4}">资源</a></li>
        ...
        <div class="main-cnt">
            <div class="pageLeft">
                <happy-scroll class="mainLeft" resize>
                    <ul>
                        <li class="leftItem" v-for="(item,index) in leftItem" :key="item.title+index" @click="itemClick">{{item.title}}</li>
                    </ul>
                </happy-scroll>
            </div>
            <div class="pageRight">
...
<script>
    export default {
        ...
        methods:{
            ...
            itemClick(){
                let temp = this.randomIntegerInRange(1,3)
                this.$router.push({name:"page" + temp})
            }
        }
