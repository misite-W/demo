<template>
    <div>
        ...
        <lock-screen v-if="lockVisible" :lockVisible.sync="lockVisible"></lock-screen>
    </div>
</template>
...
<script>
    ...
    import lockScreen from '@/components/example/LockScreen1.vue';
    import screenfull from 'screenfull'
    import LockScreen from "../../components/example/LockScreen1";
    export default {
        name: "toolbarPage",
        components: {
            LockScreen,
        ...
        data: () => {
            return {
                ...
                getDataWay:{dataType:"url",firstRequest:false, type:"get",data:'/mockData/demo/data.json',param:{}}, // 通过url方式
                columns: [
                    // {
                    //     label: '会议名称',
                    //     prop: 'name',
        ...
        created(){
            this.$$request({url:"/tech/vehicle/expert/list",type:"get"}).then((data)=>{
                console.log(data)
            })
            return
            let param={}
